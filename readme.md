...
---
# Beangla Programming Resources

> বাংলায় সহজবোধ্য প্রোগ্রামিং টিউটরিয়াল, রেফারেন্স এবং অন্যান্য প্রয়োজনীয় লিংকের তালিকা

For adding new links or any changes, make a pull request. Please do not add more than one link to each commit.
...
* [অবজারভার ডিজাইন প্যাটার্ণ](https://php.howtocode.dev/design-patterns/observer-pattern) - [How-to-code](http://www.howtocode.dev/)
